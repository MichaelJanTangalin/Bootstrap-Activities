...
<head>
 ...
 <body>
 	<h1 class="container-fluid">Activity 4</h1>
	<hr>
		...
		<form class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					...
					<div class="checkbox">
						<label><input type="checkbox" name="">BOOTSTRAP</label>
					</div>
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<div class="checkbox">
						<label class="checkbox-inline"><input type="checkbox" name="">PHP</label>
						<label class="checkbox-inline"><input type="checkbox" name="">BOOTSTRAP</label>
						<label class="checkbox-inline"><input type="checkbox" name="">JAVA</label>
					</div>	
				</div>
			</div>
